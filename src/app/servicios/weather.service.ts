...
export class WeatherService {
  ...
  obtenerClimaPorGeolocalizacion(coords:any){
    return this.http.get<any>(`${environment.climaApi.url}${coords.latitude}&lon=${coords.longitude}${environment.climaApi.key}&units=metric`)
  }
